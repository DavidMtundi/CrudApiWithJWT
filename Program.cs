...
builder.Services.AddScoped<IMovieService, SqlMoviesData>();
builder.Services.AddDbContextPool<MovieContext>
    (options => options.UseSqlServer(builder.Configuration.GetConnectionString("Movieddbconnectionstring"), sqlServerOptionsAction: sqlOptions =>
    {
